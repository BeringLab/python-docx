...
class CT_Blip(BaseOxmlElement):
    ...
    embed: str = OptionalAttribute("r:embed", ST_RelationshipId)
...
class CT_Inline(BaseOxmlElement):
    ...
    def new(cls, cx, cy, shape_id, pic):
        ...
        as parameters.
        """
        inline: CT_Inline = parse_xml(cls._inline_xml())
        inline.extent.cx = cx
        inline.extent.cy = cy
...
class CT_NonVisualDrawingProps(BaseOxmlElement):
    ...
    id: int = RequiredAttribute("id", ST_DrawingElementId)
...
class CT_Picture(BaseOxmlElement):
    ...
    @classmethod
    def new(cls, pic_id: int, filename: str, rId: str, cx, cy):
        """
        ...
        """
        pic: CT_Picture = parse_xml(cls._pic_xml())
...
class CT_PictureNonVisual(BaseOxmlElement):
    ...
    cNvPr: CT_NonVisualDrawingProps = OneAndOnlyOne("pic:cNvPr")
...
class CT_PositiveSize2D(BaseOxmlElement):
    ...
    cx: Emu = RequiredAttribute("cx", ST_PositiveCoordinate)
    cy: Emu = RequiredAttribute("cy", ST_PositiveCoordinate)
...
class CT_Transform2D(BaseOxmlElement):
    ...
    off: CT_Point2D = ZeroOrOne("a:off", successors=("a:ext",))
    ext: CT_PositiveSize2D = ZeroOrOne("a:ext", successors=())
